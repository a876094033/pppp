<template>
  <div>
    <img :src="options.img" title="点击上传项目图片" class="img-circle img-lg" @click="editCropper()">
...
import { uploadAvatar } from '@/api/borrow/borrow'
      ...
      this.$refs.cropper.getCropBlob(data => {
        ...
        uploadAvatar(formData).then(response => {
          if (response.code === 200) {
            ...
            this.parent.form.borrowImg = response.data
